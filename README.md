🎵 **MusicDB – Mini DBMS Project**

A simple Music Database Management System built using Flask and MySQL.
The application allows users to manage singers, albums, genres, and tracks with a clean web interface.
